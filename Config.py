...
fawiki_latest_langlinks_dump = join(wikipedia_dumps_dir, 'fawiki-latest-langlinks.sql')
fawiki_latest_page_dump = join(wikipedia_dumps_dir, 'fawiki-latest-page.sql')
